 ...
 *
 * `absence` is written from increment 25: the survey deposits one when an exhausted search of a
 ...
 * A glob-surface anchor, for an absence whose subject is narrower than a directory, is still
 * increment 18's.
 *
