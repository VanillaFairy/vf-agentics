...
//
// Design: docs/DESIGN.md#coding.
//
// Pure core: `parseLog` reads the delimited `git log` text `LOG_FORMAT` asks for; `analyzeSeries`
...
/** Strip a single trailing \r, so CRLF input parses identically to LF. */
